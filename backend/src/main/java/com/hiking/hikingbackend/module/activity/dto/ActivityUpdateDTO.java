...
public class ActivityUpdateDTO {
    ...
    @Schema(description = "活动标题", example = "周末香山徒步（修改版）")
    @Size(max = 100, message = "活动标题最多100个字符")
    private String title;

    @Schema(description = "封面图片URL", example = "https://example.com/image-new.jpg")
    ...
    @Schema(description = "活动日期", example = "2024-12-29")
    ...
    @Schema(description = "预计结束时间", example = "17:00:00")
    ...
    @Schema(description = "人数上限", example = "25")
    @Min(value = 1, message = "人数上限至少为1")
    @Max(value = 200, message = "人数上限最多200")
    private Integer maxParticipants;

    @Schema(description = "报名截止时间", example = "2024-12-27 23:59:59")
    ...
    @Schema(description = "费用（元）", example = "60.00")
    @DecimalMin(value = "0.00", message = "费用不能为负数")
    private BigDecimal fee;

    @Schema(description = "费用说明", example = "包含交通费、保险费、午餐")
    @Size(max = 500, message = "费用说明最多500个字符")
    private String feeDescription;

    @Schema(description = "装备要求", example = "登山鞋、背包、水壶、雨具")
    ...
    @Schema(description = "最小年龄限制", example = "16")
    @Min(value = 0, message = "最小年龄不能为负数")
    private Integer ageMin;

    @Schema(description = "最大年龄限制", example = "60")
    @Min(value = 0, message = "最大年龄不能为负数")
    private Integer ageMax;

    @Schema(description = "经验要求：0不限 1初级以上 2中级以上 3高级以上", example = "2")
